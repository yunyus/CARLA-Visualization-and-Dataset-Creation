...
export_folder = 'lusifermaykilsin' + str(time.time())
...
def process_data(self):
    ...
    for walker in walkers:
        ...
        df.loc[len(df)] = ["Walker", walker_id, tick_count, location.x, location.y, direction.x, direction.y, speed, 0]
...
class World(object):
    ...
    def __init__(self, carla_world, hud, args):
        ...
        # Pole 1
        camera_transform = carla.Transform(carla.Location(x=40, y=-200, z=6), carla.Rotation(camera_pitch, 180, 0))
        ...
        self.camera_front_rgb.listen(self.image_queue_front_rgb.put)
    ...
    def processCameraQueue(self):
        ...
        if tick_count != 0:
            ...
            while (self.image_queue_front_rgb.empty() == False):
                ...
                if (cnt % 20 == 0):
                    image_front_rgb.save_to_disk(export_folder + f'\\front_rgb_{cnt:06d}.png')
    ...
    def tick(self, clock):
        ...
        for actor in walker_list:
            ...
            playor_direction = actor.get_control().direction
            player_location = player_transform.location
            if (player_location.y < -215 and playor_direction.y == -1):
                actor.destroy()
                walker_list.remove(actor)

            elif (player_location.y > -190 and playor_direction.y == 1):
                actor.destroy()
                walker_list.remove(actor)
            ...
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    if (world.recording_enabled):
                        ...
                        client.start_recorder("C:\\Users\\anony\\Desktop\\Recordings\\manual_recording.log")
